    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="{{ url('/') }}"><img src="{{ asset('template/assets/images/logo/c.png') }}" alt="Logo" srcset=""></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-title">CONFIGURATION MENU</li>
                <li class="sidebar-item {{ Request::is('heater*') ? 'active' : '' }}">
                    <a href="{{ route('heater.index') }}" class='sidebar-link'>
                        <i class="bi bi-collection-fill"></i>
                        <span>Heater</span>
                    </a>
                </li>
                <li class="sidebar-item {{ Request::is('lamp*') ? 'active' : '' }}">
                    <a href="{{ route('lamp.index') }}" class='sidebar-link'>
